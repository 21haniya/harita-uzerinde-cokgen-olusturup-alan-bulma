...
int main() {
    ...
    curl_easy_setopt(curl, CURLOPT_WRITEDATA, file); //ikisi beraber çalþýr
    ...
    //oku_devam true olduðu sürece okumaya devam edecek ve mevcut_satir izlenecek 
    bool oku_devam  = true;
    int mevcut_satir = 1;
    ...
    do {
       ...
       //kullanýcýnýn aradýðý satýra gelir
    ...
    int ekranDizi[2 * koSayisi]; //ekran koordinatlarýný bir diziye atma, drawpoly için gerekli
    int index = 0;
